...
void main() {
  ...
  test('EleMarsh estimate()', () async {
    ...
    weightGuess = weightGuess + 1) {
        ...
        guessRow row = (weightGuess: weightGuess, bolusGuess: initBoluesGuess, SSRE: SSRE, maxPE: maxPE, inductionCPTarget: inductionCPTarget);
    ...
    bolusGuess=bolusGuess + 2) {
      ...
      guessRow row = (weightGuess: weightBestGuess, bolusGuess: bolusGuess, SSRE: SSRE, maxPE: maxPE, inductionCPTarget: inductionCPTarget);
    ...
    double inductionCPTarget = bestGuessRow.inductionCPTarget;
